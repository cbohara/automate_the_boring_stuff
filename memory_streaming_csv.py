...
def time_series(start_date, start_time, end_date, end_time, interval):
    ...
    # return times as required to search within grafana csv
    time_series = []
...
def main(script):
    ...
    try:
        ...
        print('python3 memory_streaming_csv.py [csv_file] [start_date] [start_time] [end_date] [end_time] [analysis window(seconds)]')
    else:
